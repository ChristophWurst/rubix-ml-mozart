...
use Test\Vendor\Rubix\ML\CrossValidation\Reports\ContingencyTable;
use InvalidArgumentException;

use function count;
use function Test\Vendor\Rubix\ML\comb;
...
class RandIndex implements Metric
{
    ...
    public function score(array $predictions, array $labels) : float
    {
        ...
        $table = TEST_Matrix::build((new ContingencyTable())->generate($labels, $predictions));
