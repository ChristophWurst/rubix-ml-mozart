...
use Test\Vendor\Rubix\ML\Graph\Nodes\Ball;
use Test\Vendor\Rubix\ML\Graph\Nodes\Cluster;
use Test\Vendor\Rubix\ML\Graph\Nodes\Hypersphere;
...
class BallTree implements BinaryTree, Spatial
{
     ...
     *
     * @var \Test\Vendor\Rubix\ML\Graph\Nodes\Ball|null
     */
    protected $root;
     ...
     *
     * @return \Test\Vendor\Rubix\ML\Kernels\Distance\Distance
     */
     ...
     *
     * @param (string|int|float)[] $sample
     * @return \Test\Vendor\Rubix\ML\Graph\Nodes\Hypersphere[]
     */
