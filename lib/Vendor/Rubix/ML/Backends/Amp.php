...
use Amp\Loop;
use Test\Vendor\Rubix\ML\Other\Helpers\CPU;
use Test\Vendor\Rubix\ML\Backends\Tasks\Task;
use Test\Vendor\Amp\Parallel\Worker\DefaultPool;
use Test\Vendor\Amp\Parallel\Worker\CallableTask;
use Test\Vendor\Amp\Parallel\Worker\Task as AmpTask;
...
class Amp implements Backend
{
     ...
     * The worker pool.
     *
     * @var \Test\Vendor\Amp\Parallel\Worker\Pool
     */
    protected $pool;
     ...
     *
     * @param \Test\Vendor\Amp\Parallel\Worker\Task $task
     * @param callable|null $after
